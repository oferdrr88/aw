...
const { createRandomNumber } = require('../utils');
...
module.exports = {
    ...
    details: async function (req, res, next) {
        ...
        try {
            ...
            const card = await Card.findById({ _id: monggose.Types.ObjectId(value.id) });
    ...
    addNew: async function (req, res, next) {
        ...
        try {
            ...
            const card = new Card({
                ...
                phone: value.phone,
                image: {
                    url: value.url ? value.url : 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png',
                    alt: value.alt ? value.alt : 'Pic Of Business Card',
                },
                bizNumber: createRandomNumber(7),
                user_id: user._id,
            });
    ...
    deleteCard: async function (req, res, next) {
        ...
        try {
            ...
            console.log('LINE 159:', value, user);
